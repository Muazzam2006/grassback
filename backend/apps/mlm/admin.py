...
StatusThreshold._meta.get_field("status").verbose_name = "Статус"
StatusThreshold._meta.get_field("status").choices = [
    ("BRONZE", "Бронза"),
    ("SILVER", "Серебро"),
    ("GOLD", "Золото"),
]
StatusThreshold._meta.get_field("min_personal_turnover").verbose_name = "Мин. личный оборот"
StatusThreshold._meta.get_field("min_personal_turnover").help_text = ""
StatusThreshold._meta.get_field("min_team_turnover").verbose_name = "Мин. командный оборот"
StatusThreshold._meta.get_field("min_team_turnover").help_text = ""
StatusThreshold._meta.get_field("updated_at").verbose_name = "Обновлено"

NetworkStats._meta.get_field("user").verbose_name = "Пользователь"
NetworkStats._meta.get_field("team_size").verbose_name = "Размер структуры"
NetworkStats._meta.get_field("team_sales").verbose_name = "Оборот структуры"
NetworkStats._meta.get_field("updated_at").verbose_name = "Обновлено"
